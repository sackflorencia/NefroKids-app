...
const getArcColor = (index, estrellas) => {
...
export default function LevelNode({ number, unlocked = true, onPress, estrellas = 0 }) {
  const arcColors = [0, 1, 2].map((index) => getArcColor(index, estrellas));
